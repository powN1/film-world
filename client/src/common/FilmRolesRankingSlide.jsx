	...
	return (
		...
		>
			...
			<div className="w-full flex flex-col gap-y-4 py-3 items-center text-center duration-300">
				<p>{actorSpecific ? role.characterName : actor.personal_info.name}</p>

				{actorSpecific ? (
					<Link
						to={filmLink}
						className="text-sm text-yellow-800 hover:text-yellow-600 duration-300"
					>
				...
				<div className="w-full flex justify-center items-center gap-x-3">
					...
					<p className="text-gray-400 flex items-center justify-center">
						{role.activity.ratedByCount} ratings
					</p>
				</div>
			</div>
		</Link>
