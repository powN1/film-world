...
const MainNews = () => {
	...
	return (
		<div className="bg-white">
			<div
				className="lg:w-[55%] mx-auto bg-black grid grid-rows-[80px_80px_80px_80px_80px_80px] 3xl:grid-rows-[110px_110px_110px_110px_110px_110px] 4xl:grid-rows-[160px_160px_160px_160px_160px_160px] grid-cols-[3fr_3fr_4fr] max-md:grid-rows-[70px_70px_70px_70px_70px_70px_70px_70px_70px_70px_70px] max-md:grid-cols-[1fr_1fr] gap-7 max-md:gap-5 p-4"
			>
