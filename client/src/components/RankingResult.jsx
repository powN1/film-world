...
const RankingResult = (props) => {
	const { index, img, title, titleId, year, genre, rating, ratedByCount } = props;
	return (
      ...
      <div className="hidden lg:flex justify-center items-center text-xl pl-4 w-[5%]">{index+1}</div>
			<Link to={`/${titleId}`} className="relative min-w-[100px] w-[100px] min-h-[150px] max-h-[150px] md:min-w-[90px] md:w-[90px] md:min-h-[125px] border border-gray-300 cursor-pointer">
